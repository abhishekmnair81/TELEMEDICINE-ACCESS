...
urlpatterns = [
    ...
    path('voice/transcribe/', voice_to_text, name='voice_to_text'),
    ...
    path('medication-reminders/run-email-reminders/',   run_email_reminders_now,  name='run-email-reminders'),
    ...
    path('video-consultations/process-copilot-audio/', views.process_copilot_audio, name='process-copilot-audio'),
