...
SECRET_KEY = 'django-insecure-dxo7x)05d)os=ky%4@^5-)9ls+9_0@^9c3(d)l%@#-pa_mnawk'
...
ASGI_APPLICATION = 'medical_backend.asgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'teamtelemedicineruralindia@gmail.com' 
